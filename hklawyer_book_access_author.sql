...
--
-- Table structure for table `book_access_author`
--

DROP TABLE IF EXISTS `book_access_author`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `book_access_author` (
  `nid` int(11) NOT NULL DEFAULT '0' COMMENT 'Primary key: The node ID of the book.',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Primary key: The user ID of the book author.',
  ...
  PRIMARY KEY (`nid`,`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table for tracking book access by author.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `book_access_author`
--

LOCK TABLES `book_access_author` WRITE;
/*!40000 ALTER TABLE `book_access_author` DISABLE KEYS */;
INSERT INTO `book_access_author` VALUES (8901,1,1,1,1,0,1,1),(8911,1,0,0,0,0,0,0);
/*!40000 ALTER TABLE `book_access_author` ENABLE KEYS */;
UNLOCK TABLES;
