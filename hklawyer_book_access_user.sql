...
--
-- Table structure for table `book_access_user`
--

DROP TABLE IF EXISTS `book_access_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `book_access_user` (
  `nid` int(11) NOT NULL DEFAULT '0' COMMENT 'Primary key: The node ID of the book.',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Primary key: The user ID associated with a book node ID.',
  ...
  PRIMARY KEY (`nid`,`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table for tracking book access by user.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `book_access_user`
--

LOCK TABLES `book_access_user` WRITE;
/*!40000 ALTER TABLE `book_access_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `book_access_user` ENABLE KEYS */;
UNLOCK TABLES;
