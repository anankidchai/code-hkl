...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 7 (field_ad_flash)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_ad_flash`
--

LOCK TABLES `field_data_field_ad_flash` WRITE;
/*!40000 ALTER TABLE `field_data_field_ad_flash` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_ad_flash` ENABLE KEYS */;
UNLOCK TABLES;
