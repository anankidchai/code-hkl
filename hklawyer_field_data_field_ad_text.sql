...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 8 (field_ad_text)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_ad_text`
--

LOCK TABLES `field_data_field_ad_text` WRITE;
/*!40000 ALTER TABLE `field_data_field_ad_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_ad_text` ENABLE KEYS */;
UNLOCK TABLES;
