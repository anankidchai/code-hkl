...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 31 (field_adcamp_days)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_adcamp_days`
--

LOCK TABLES `field_data_field_adcamp_days` WRITE;
/*!40000 ALTER TABLE `field_data_field_adcamp_days` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_adcamp_days` ENABLE KEYS */;
UNLOCK TABLES;
