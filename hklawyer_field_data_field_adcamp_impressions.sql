...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 27 (field_adcamp_impressions)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_adcamp_impressions`
--

LOCK TABLES `field_data_field_adcamp_impressions` WRITE;
/*!40000 ALTER TABLE `field_data_field_adcamp_impressions` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_adcamp_impressions` ENABLE KEYS */;
UNLOCK TABLES;
