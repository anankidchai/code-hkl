...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 32 (field_adcamp_start)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_data_field_adcamp_start`
--

LOCK TABLES `field_data_field_adcamp_start` WRITE;
/*!40000 ALTER TABLE `field_data_field_adcamp_start` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_data_field_adcamp_start` ENABLE KEYS */;
UNLOCK TABLES;
