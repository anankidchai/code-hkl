...
--
-- Table structure for table `field_data_field_uberflip_url`
--

DROP TABLE IF EXISTS `field_data_field_uberflip_url`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `field_data_field_uberflip_url` (
...
-- Dump completed on 2016-05-10 18:44:19
