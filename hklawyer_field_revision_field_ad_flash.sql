...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 7 (field_ad_flash)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_revision_field_ad_flash`
--

LOCK TABLES `field_revision_field_ad_flash` WRITE;
/*!40000 ALTER TABLE `field_revision_field_ad_flash` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_revision_field_ad_flash` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-10 18:44:18
