...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 27 (field_adcamp...';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `field_revision_field_adcamp_impressions`
--

LOCK TABLES `field_revision_field_adcamp_impressions` WRITE;
/*!40000 ALTER TABLE `field_revision_field_adcamp_impressions` DISABLE KEYS */;
/*!40000 ALTER TABLE `field_revision_field_adcamp_impressions` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-10 18:40:43
