...
--
-- Table structure for table `field_revision_field_pdf_url`
--

DROP TABLE IF EXISTS `field_revision_field_pdf_url`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `field_revision_field_pdf_url` (
  ...
  `field_pdf_url_value` varchar(600) DEFAULT NULL,
  `field_pdf_url_format` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2016-05-10 18:42:22
